...
|-----|---------|------------|------------------|
| 🎮 | **[Player Retention Analysis](https://github.com/liiyq/CookieCats_ABTest/blob/main/README.md)** | `Python` `SciPy` `Bootstrapping` | Increased 7-day retention by 18% through 10,000-iteration A/B testing |
